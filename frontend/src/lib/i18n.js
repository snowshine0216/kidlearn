...
const STRINGS = {
  zh: {
    ...
    quizCountLabel: '题目数量',
    quizModeLabels: { pronunciation: '跟读发音', fillBlank: '选择填空', wordMeaning: '词义配对', reading: '认字朗读' },
    quizStart: '开始 🚀',
  ...
  en: {
    ...
    quizModeLabels: { pronunciation: 'Pronunciation', fillBlank: 'Fill the Blank', wordMeaning: 'Word → Meaning', reading: 'Reading' },
    quizStart: 'Start 🚀',
