...
```bash
cd frontend
npm run test        # run all tests once (221 tests)
npm run test:watch  # watch mode
```

Tests use Vitest + @testing-library/react. Covers: i18n, speech, claudeApi, quizLogic, quizHintApi, colorThemes, and all React components.
